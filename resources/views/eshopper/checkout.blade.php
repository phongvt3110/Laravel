					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{action('Frontend\FrontendController@checkout')}}" class="active"><i class="fa fa-crosshairs"></i> Checkout</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{action('Frontend\FrontendController@checkout')}}" class="active">Checkout</a></li>
