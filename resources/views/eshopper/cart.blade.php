					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{action('Frontend\FrontendController@cart')}}" class="active"><i class="fa fa-shopping-cart"></i> Cart</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{action('Frontend\FrontendController@cart')}}" class="active">Cart</a></li>
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{asset('../resources/assets/eshopper/images/cart/one.png')}}" alt=""></a>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{asset('../resources/assets/eshopper/images/cart/two.png')}}" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{asset('../resources/assets/eshopper/images/cart/three.png')}}" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
