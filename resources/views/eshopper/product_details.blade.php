					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{action('Frontend\FrontendController@checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="{{action('Frontend\FrontendController@cart')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
								<li><a href="{{action('Frontend\FrontendController@login')}}"><i class="fa fa-lock"></i> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{action('Frontend\FrontendController@index')}}">Home</a></li>
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{action('Frontend\FrontendController@shop')}}">Products</a></li>
										<li><a href="{{action('Frontend\FrontendController@product_details')}}" class="active">Product Details</a></li>
										<li><a href="{{action('Frontend\FrontendController@checkout')}}">Checkout</a></li>
										<li><a href="{{action('Frontend\FrontendController@cart')}}">Cart</a></li>
										<li><a href="{{action('Frontend\FrontendController@login')}}">Login</a></li>
                                    </ul>
                                </li> 
								<li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{action('Frontend\FrontendController@blog')}}">Blog List</a></li>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{asset('../resources/assets/eshopper/images/product-details/1.jpg')}}" alt="" />
								<h3>ZOOM</h3>
							</div>
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="{{asset('../resources/assets/eshopper/images/product-details/similar1.jpg')}}" alt=""></a>
										  <a href=""><img src="{{asset('../resources/assets/eshopper/images/product-details/similar2.jpg')}}" alt=""></a>
										  <a href=""><img src="{{asset('../resources/assets/eshopper/images/product-details/similar3.jpg')}}" alt=""></a>
										</div>
										<div class="item">
										  <a href=""><img src="{{asset('../resources/assets/eshopper/images/product-details/similar1.jpg')}}" alt=""></a>
										  <a href=""><img src="{{asset('../resources/assets/eshopper/images/product-details/similar2.jpg')}}" alt=""></a>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="{{asset('../resources/assets/eshopper/images/product-details/new.jpg')}}" class="newarrival" alt="" />
								<h2>Anne Klein Sleeveless Colorblock Scuba</h2>
								<p>Web ID: 1089772</p>
								<img src="{{asset('../resources/assets/eshopper/images/product-details/rating.png')}}" alt="" />
								<span>
									<span>US $59</span>
								...
								<a href=""><img src="{{asset('../resources/assets/eshopper/images/product-details/share.png')}}" class="share img-responsive" alt="" /></a>
							...
							<div class="tab-pane fade" id="details" >
									...
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="{{asset('../resources/assets/eshopper/images/home/gallery1.jpg')}}" alt="" />
												<h2>$56</h2>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="{{asset('../resources/assets/eshopper/images/home/gallery2.jpg')}}" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="{{asset('../resources/assets/eshopper/images/home/gallery3.jpg')}}" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="{{asset('../resources/assets/eshopper/images/home/gallery4.jpg')}}" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										...
										<b>Rating: </b> <img src="{{asset('../resources/assets/eshopper/images/product-details/rating.png')}}" alt="" />
								...
								<div class="item active">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="{{asset('../resources/assets/eshopper/images/home/recommend1.jpg')}}" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="{{asset('../resources/assets/eshopper/images/home/recommend2.jpg')}}" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="{{asset('../resources/assets/eshopper/images/home/recommend3.jpg')}}" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
