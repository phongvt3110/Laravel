					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{action('Frontend\FrontendController@index')}}" class="active">Home</a></li>
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{action('Frontend\FrontendController@shop')}}">Products</a></li>
										<li><a href="{{action('Frontend\FrontendController@product_details')}}">Product Details</a></li>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{asset('../resources/assets/eshopper/images/home/girl1.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('../resources/assets/eshopper/images/home/pricing.png')}}" class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src="{{asset('../resources/assets/eshopper/images/home/girl2.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('../resources/assets/eshopper/images/home/pricing.png')}}" class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{asset('../resources/assets/eshopper/images/home/girl3.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('../resources/assets/eshopper/images/home/pricing.png')}}" class="pricing" alt="" />
								</div>
							</div>
